...
<html lang="en">
  <head>
    ...
    <title>Eliminar Tamaño Pizza</title>
  </head>
  <body>
    <div class="container">
    <h1>Eliminar Tamaño Pizza</h1>
    </div>
...
<div class="card m-5" style="width: 25rem;">
    <div class="row m-5">
        <div class="col ">
        <form method="POST" action=" {{ route('pizza_sizes.update',['pizzaSize'=>$pizzaSize]) }} ">
            @method('put')
            @csrf
            <div class="mb-3">
            ...
            <select class="form-select" name="code" id="pizza" required>
                ...
                @foreach( $pizzas as $pizza)
                    @if( $pizza->id == $pizzaSize->pizza_id)
