    ...
    <div class="row m-5">
        ...
        <form method="POST" action=" {{ route('ingredients.update',['ingredient'=>$ingredient->id]) }} ">
            ...
            <div class="mb-3">
                ...
                value="{{ $ingredient->id }}">
                <div id="idHelp" class="form-text">Código Ingrediente</div>
            </div>

            <div class="mb-3">
                <label for="name" class="form-label">Nombre</label>
                <input type="text" class="form-control" id="name" aria-describedby="nameHelp" name="name" placeholder="Nombre Ingrediente"
                value=" {{ $ingredient->name }} ">
                <div id="nameHelp" class="form-text">Nombre Ingrediente</div>
            </div>
            ...
            <div class="mb-3">
                ...
                <a href=" {{ route('ingredients.index') }} " class="btn btn-danger"> 
