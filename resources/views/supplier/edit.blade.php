    ...
    <div class="row m-5">
        ...
        <form method="POST" action=" {{ route('suppliers.update',['supplier'=>$supplier->id]) }} ">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="name" aria-describedby="nameHelp" name="name" placeholder="Nombre Proveedor"
                value="{{ $supplier->name }}">
                <div id="nameHelp" class="form-text">Nombre Proveedor</div>
            </div>

            <div class="mb-3">
                <label for="contact" class="form-label">Información de Contacto</label>
                <input type="text" class="form-control" id="contact" aria-describedby="contactHelp" name="contact" placeholder="Nombre Proveedor"
                value="{{ $supplier->contact_info }}">
                <div id="contactHelp" class="form-text">Nombre Proveedor</div>
            </div>
